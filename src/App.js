...
function App() {
    ...
    const upgrades = [
        {
            description: '+0.3g',
            photo: 'https://icon-library.com/images/gold-bar-icon/gold-bar-icon-3.jpg',
            upgrade: 0.3,
            price: 50
        },
        {
        ...
        {
            description: '+1 slot',
            photo: 'https://static.vecteezy.com/system/resources/thumbnails/024/684/179/small/carton-box-3d-rendering-object-icon-illustration-png.png',
            upgrade: 1,
            price: 100
        }
    ]
